...
export default async function InstructorCourseAttendancePage({
  params,
}: {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <SessionList courseId={courseId} sessions={sessions} attendanceBasePath="/app/instructor/attendance" />
    </div>
  );
}
